...
<div class="left">
<ul><li class="sld1" style="background: url(/img/tmp/index1.jpg) no-repeat top center; background-size: cover;"></li><li class="sld2" style="background: url(/img/tmp/index2.jpg) no-repeat top center; background-size: cover;"></li><li class="sld3" style="background: url(/img/tmp/index3.jpg) no-repeat top center; background-size: cover;"></li></ul>
</div>
<div class="right">
<div class="inner">
...
<div class="inner">
<h2>活動レポート<span>高齢者法研究会の活動状況、会員の視察の報告などをお伝えします</span></h2>
...
$str = get_post_meta($post->ID, "dateEnd", TRUE);
 ?>
<div class="block activity"><a href="<?php the_permalink(); ?>" class="btn"><p class="img"><?php if(has_post_thumbnail()){
...
$str = get_post_meta($post->ID, "dateEnd", TRUE);
 ?>
<div class="block column"><a href="<?php the_permalink(); ?>" class="btn"><p class="img"><?php if(has_post_thumbnail()){
	the_post_thumbnail("thumbnail");
} else { ?>
<img src="/img/thumb_blank.png" width="222" height="148" /><?php } ?></p><p class="mark"></p><p class="date"><?php echo get_post_time('Y.m.d'); if($str){
     echo " 〜 " . $str;
...
$str = get_post_meta($post->ID, "dateEnd", TRUE);
 ?>
<div class="block oversea"><a href="<?php the_permalink(); ?>" class="btn"><p class="img"><?php if(has_post_thumbnail()){
	the_post_thumbnail("thumbnail");
} else { ?>
<img src="/img/thumb_blank.png" width="222" height="148" /><?php } ?></p><p class="mark"></p><p class="date"><?php echo get_post_time('Y.m.d'); if($str){
     echo " 〜 " . $str;
...
$str = get_post_meta($post->ID, "dateEnd", TRUE);
 ?>
<div class="block domestic"><a href="<?php the_permalink(); ?>" class="btn"><p class="img"><?php if(has_post_thumbnail()){
	the_post_thumbnail("thumbnail");
} else { ?>
<img src="/img/thumb_blank.png" width="222" height="148" /><?php } ?></p><p class="mark"></p><p class="date"><?php echo get_post_time('Y.m.d'); if($str){
     echo " 〜 " . $str;
